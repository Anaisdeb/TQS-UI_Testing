...
public class BuySteps {
	...
	public void theUserEntersThePersonalInformation(String FirstName, String LastName, String Email, String Phone,
			String Address) {
		...
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[1]/div[2]/div/div/div[6]/div/div/div/span/span[1]/span"))
				.sendKeys(Keys.RETURN);
		driver.findElement(By.xpath("//*[@id=\"fadein\"]/span/span/span[1]/input")).sendKeys("spain" + Keys.RETURN);
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[1]/div[2]/div/div/div[7]/div/div/div/span/span[1]/span"))
				.sendKeys(Keys.RETURN);
		driver.findElement(By.xpath("//*[@id=\"fadein\"]/span/span/span[1]/input")).sendKeys("spain" + Keys.RETURN);
	...
	public void theUserEntersTheTravellerInformation(String FirstName, String LastName, String Passport) {
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[1]/div[1]/select/option[2]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[2]/div[1]/select/option[210]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[1]/select/option[13]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/select/option[24]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[3]/select/option[23]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/select/option[7]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div[2]/div/div[2]/select/option[7]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div[3]/div/div[1]/select/option[13]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div[3]/div/div[2]/select/option[13]"))
				.click();
	...
	public void theUserConfirmTheBooking() {
		executor.executeScript("arguments[0].click()",
				driver.findElement(By.xpath("//*[@id=\"myTab\"]/label/label/label/label/label")));
	...
	public void theUserClickTheFirstHotelOption() {
		driver.findElement(
				By.xpath("//*[@id=\"availability\"]/div[2]/div/div[2]/div/div[2]/form/div/div[5]/div/button"))
				.sendKeys(Keys.RETURN);
	}

	@When("^the user enters the travellers information (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*)")
	public void theUserEntersTheTravellersInformation(String FirstName, String LastName, String FirstName1,
			String LastName1, String FirstName2, String LastName2, String FirstName3, String LastName3) {
		...
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div[1]/div[2]/div/div[1]/select/option[2]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div[3]/div[2]/div/div[1]/select/option[12]"))
				.click();
		driver.findElement(By.xpath(
				"//*[@id=\"fadein\"]/div[5]/form/section/div/div/div[1]/div[2]/div[2]/div[4]/div[2]/div/div[1]/select/option[6]"))
				.click();
	}
	...
	public void theUserEntersTheTourParticipants() {
		...
		driver.findElement(
				By.xpath("//*[@id=\"fadein\"]/section[2]/div[2]/div/div/div[2]/div/div/div/form/div[3]/button"))
				.sendKeys(Keys.RETURN);
	}

	@When("^the user enters the tour travellers information (.*), (.*), (.*), (.*), (.*), (.*), (.*), (.*)")
	public void theUserEntersTheTourTravellerInformation(String FirstName, String LastName, String FirstName1,
			String LastName1, String FirstName2, String LastName2, String FirstName3, String LastName3) {
		driver.findElement(By.cssSelector("input[name='firstname_2']")).sendKeys(FirstName);
		driver.findElement(By.cssSelector("input[name='lastname_2']")).sendKeys(LastName);
